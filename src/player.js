...
export default class Player{
  ...
  fireBullet(orientation, orientations){
    switch(orientation){
      case "left":
        this.bullets.push(new Bullet(this.position.x + (this.width*.333),this.position.y + (this.height/2), orientation,orientations, this.gameWidth, this.gameHeight));
        break;
      case "right":
        this.bullets.push(new Bullet(this.position.x + (this.width*.5),this.position.y + (this.height/2), orientation,orientations, this.gameWidth, this.gameHeight));
        break;
      case "up":
        this.bullets.push(new Bullet(this.position.x + (this.width*0.5), this.position.y + (this.height*0.333), orientation,orientations, this.gameWidth, this.gameHeight));
