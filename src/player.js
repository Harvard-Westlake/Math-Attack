...
export default class Player{
  ...
  constructor(gameWidth, gameHeight){
    ...
    this.playerImage.src = "/images/idleAndJumpSpriteSheet.png";
    ...
    this.playerState = "jump" //this variable controls what animation runs, match it to the names in the animationStates variable
